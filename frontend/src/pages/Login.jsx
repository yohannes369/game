...
export default function HomePage() {
  ...
  const features = [
    {
      ...
      description: t(
        'home.liveDrawsDesc',
        'Watch real-time lottery draws as they happen'
      ),
    ...
    },
    {
      ...
      description: t(
        'home.bigPrizesDesc',
        'Win massive jackpots and life-changing amounts'
      ),
    ...
    },
    {
      ...
      description: t(
        'home.secureDesc',
        'Your transactions and data are fully protected'
      ),
  ...
  const stats = [
    {
      value: '10,000+',
      label: t('home.activePlayers', 'Active Players'),
    },
    {
      value: '500,000+',
      label: t('home.prizesGiven', 'Prizes Given (Birr)'),
    },
    {
      value: '1,000+',
      label: t('home.winners', 'Winners'),
    },
    {
      value: '24/7',
      label: t('home.support', 'Support'),
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center">
              <Link to="/" className="flex items-center gap-4 group">
                ...
                <div>
                  <span className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-green-600">
                    Tolo Dersah
                  </span>
            ...
            <div className="hidden md:flex items-center gap-8">
              <a
                href="#features"
                className="relative text-slate-600 hover:text-emerald-600 font-semibold transition-colors group"
              >
          ...
          {isMenuOpen && (
            <div className="md:hidden border-t border-slate-200 py-4 space-y-2">
              <a
                href="#features"
                className="block px-4 py-3 text-slate-600 hover:bg-emerald-50 rounded-xl font-medium"
              >
                {t('nav.features', 'Features')}
              </a>
              ...
              <a
                href="tel:0997294511"
                className="block px-4 py-3 text-emerald-600 font-bold"
              >
                📞 0997294511
              </a>
            </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-900 to-green-900 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-6 py-2 mb-8">
              <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
              <span className="text-sm font-medium">
                Tolo Dersah Chewata - 0997294511
              </span>
            </div>
            ...
            <p className="text-xl md:text-2xl lg:text-3xl mb-10 text-emerald-100 font-light max-w-3xl mx-auto">
              {t(
                'home.heroSubtitle',
                'Join thousands of winners. Your lucky ticket is just a click away.'
              )}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              {user ? (
                <Link
                  to="/lotteries"
                  className="group relative bg-gradient-to-r from-emerald-400 to-green-500 text-slate-900 px-10 py-5 rounded-2xl font-bold text-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                >
                  {t('home.playNow', 'Play Now')} 🎲
                </Link>
              ) : (
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {stats.map((stat, idx) => (
            <div
              key={idx}
              className="group bg-white rounded-2xl shadow-xl p-8 text-center border border-green-50"
            >
              <div className="text-3xl md:text-4xl font-black bg-gradient-to-br from-emerald-600 to-green-600 text-transparent bg-clip-text mb-3">
                {stat.value}
              </div>
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto">
            {t(
              'home.featuresDesc',
              'We offer the best lottery experience with amazing features'
            )}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="group bg-white rounded-3xl shadow-xl p-8 border border-green-50"
            >
              <div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              {
                step: '1️⃣',
                title: t('home.step1', 'Create Account'),
                desc: t(
                  'home.step1Desc',
                  'Sign up in seconds and verify your account'
                ),
              },
              {
                step: '2️⃣',
                title: t('home.step2', 'Buy Tickets'),
                desc: t(
                  'home.step2Desc',
                  'Choose your lucky numbers and purchase tickets'
                ),
              },
              {
                step: '3️⃣',
                title: t('home.step3', 'Win Prizes'),
                desc: t(
                  'home.step3Desc',
                  'Watch the draw and collect your winnings'
                ),
              },
            ].map((item, idx) => (
              <div key={idx} className="text-center group">
                <div className="relative w-24 h-24 bg-gradient-to-br from-emerald-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {recentWinners.map((winner, idx) => (
            <div
              key={idx}
              className="group bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 rounded-3xl p-8 border border-green-200 shadow-xl"
            >
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-emerald-400 to-green-500 rounded-full flex items-center justify-center text-white font-black text-xl shadow-xl">
                  {winner.name.charAt(0)}
                </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-600 via-green-600 to-teal-700 text-white py-24">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-10 text-emerald-100 max-w-2xl mx-auto">
            {t(
              'home.readyDesc',
              'Join now and get your first ticket! Call 0997294511'
            )}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            {user ? (
              <Link
                to="/lotteries"
                className="group bg-white text-emerald-600 px-10 py-5 rounded-2xl font-bold text-xl inline-flex items-center gap-3"
              >
                {t('home.playNow', 'Play Now')} 🎲
              </Link>
            ) : (
            ...
            <a
              href="tel:0997294511"
              className="group bg-white/10 border-2 border-white/30 text-white px-10 py-5 rounded-2xl font-bold text-xl inline-flex items-center gap-3"
            >
              📞 0997294511
            </a>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-slate-400">
                <li>📧 support@tolodersah.com</li>
                <li>
                  📞{' '}
                  <a href="tel:0997294511">
                    0997294511
                  </a>
                </li>
                <li>📍 Addis Ababa, Ethiopia</li>
          ...
          <div className="border-t border-slate-800 pt-8 text-center text-slate-500">
            <p>
              &copy; {new Date().getFullYear()} Tolo Dersah Chewata.{' '}
              {t('app.rights', 'All rights reserved.')}
            </p>
          </div>
        </div>
      </footer>
      ...
      {showLoginModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div
            className="absolute inset-0 bg-gradient-to-br from-slate-900/80 via-emerald-900/80 to-green-900/80 backdrop-blur-md"
            onClick={() => setShowLoginModal(false)}
          ></div>
          ...
          <div className="relative w-full max-w-md">
            <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-green-100 overflow-hidden">
              ...
              <button
                onClick={() => setShowLoginModal(false)}
                className="absolute top-5 right-5 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center text-slate-400 hover:text-slate-600 z-10"
              >
                ✕
              </button>
              ...
              <div className="p-8">
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      autoComplete="username"
                      required
                      className="w-full px-4 py-4 border-2 border-slate-200 rounded-2xl focus:ring-4 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none text-slate-900 font-medium bg-slate-50 focus:bg-white"
                      placeholder={t(
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        autoComplete="current-password"
                        required
                        className="w-full px-4 py-4 pr-12 border-2 border-slate-200 rounded-2xl focus:ring-4 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none text-slate-900 font-medium bg-slate-50 focus:bg-white"
                        placeholder={t(
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="relative w-full bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500 text-white py-4 px-4 rounded-2xl font-bold text-lg hover:shadow-2xl transition-all duration-300 disabled:opacity-50"
                  >
                    {loading ? (
                      <span className="flex items-center justify-center gap-2">
                        <svg
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    type="button"
                    className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-slate-200 rounded-2xl font-medium text-slate-700"
                  >
                    📱 Google
                  </button>
      ...
      {/* IMPORTANT:
          Removed "jsx" from <style jsx>.
          React now receives a normal <style> element.
      */}
      <style>{`
        @keyframes blob {
          0%, 100% {
